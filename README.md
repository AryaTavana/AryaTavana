...
- Building [ThoughtHub](https://github.com/AryaTavana/ThoughtHub), a full-stack publishing community with authoring, moderation, notifications, saved posts, and multilingual content support.
- Developing [discourse-topic-reply-limits](https://github.com/AryaTavana/discourse-topic-reply-limits), an open-source Discourse plugin for subscription-aware reply quotas.
- Strengthening frontend engineering skills through focused React and TypeScript exercises.
...
| [AI/ML/DL Learning](https://github.com/AryaTavana/AI-ML-DL-Learning) | Machine-learning exercises, currently including Iris classification with a k-nearest-neighbors model. | Python, scikit-learn |

## Technical toolkit

- **Backend:** Python, Django, Django REST Framework, Ruby
- **Frontend:** JavaScript, TypeScript, React, React Router, Bootstrap, Tailwind CSS, Vite
- **Data and infrastructure:** PostgreSQL, SQLite, Docker, Nginx
- **Quality and workflow:** Git, GitHub, Jest, Testing Library, Vitest, RSpec

## Contact

The best way to reach me is at [aryatavana07@gmail.com](mailto:aryatavana07@gmail.com).
